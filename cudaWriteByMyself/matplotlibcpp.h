...
static_assert(sizeof(long long) == 8,"static_assert:sizeof(long long) == 8, fuccccck you");
//template <> struct select_npy_type<long long> { const static NPY_TYPES type = NPY_INT64; };
static_assert(sizeof(unsigned long long) == 8, "static_assert:sizeof(unsigned long long) == 8, fuccccck you");
